<template>
  <VCard  variant="text" class="container-weather">
<div class="weather-box">
    <div class="titlebar">
      <p class="date">{{ getCurrentDate() }}</p>
      <p  class="text-h4 text-white">ONTARIO</p>
      <p class="text-caption text-white">{{ getWeatherDescription().toUpperCase() }}</p>
      ...
      <section v-if="weatherData">
        <article class="temperature">
            <div class="align-center mb-4">
                <img
                    ...
                    alt="Weather Icon"
                />
                <h2  style="font-size:50px;" class="text-white">{{ Math.round(weatherData.main.temp) }}°C</h2>
            </div>
        </article>
        ...
        <div class="col">
            <div>
                <p class="text-h5 font-weight-thin text-white ">Wind Status</p>
                <p class="text-caption font-weight-thin">{{ weatherData.wind.speed }} mps</p>
            </div>
            <div>
                <p class="text-h5 font-weight-thin text-white ">Visibility</p>
                <p class="text-caption font-weight-thin">{{ weatherData.visibility / 1000 }} km</p>
            </div>
        </div>
        
        <div class="col">
            <div>
                <p class="text-h5 font-weight-thin text-white ">Humidity</p>
                <p class="text-caption font-weight-thin">{{ weatherData.main.humidity }}%</p>
            </div>
            <div>
                <p class="text-h5 font-weight-thin text-white ">Air pressure</p>
                <p class="text-caption font-weight-thin">{{ weatherData.main.pressure }} mpa</p>
            </div>
        </div>
          </article>
  </section>

  <section class="weather-box-internal" >
    <article class="d-flex justify-space-around  dark:text-gray-400">
      <div>
        <span class="text-uppercase text-body-2 ">wed</span>
          <article class="miniWeatherCard">
            <div class="text-body2">-0.4°C</div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 24px; width: 24px;" class="fill-current">
      ...
      <div>
        <span class="text-uppercase text-body-2 ">thu</span>
       <article class="miniWeatherCard">
         <div class="text-body2">-7.2°C</div>
         <svg
      ...
      <div>
      <span class="text-uppercase text-body-2 ">fri</span>
       <article class="miniWeatherCard">
         <div class="text-body2">12°C</div>
         <svg
         xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
           style="height: 24px; width: 24px;"
      ...
      <div>
        <span class="text-uppercase text-body-2 ">sat</span>
        <article class="miniWeatherCard">
          <div class="text-body2">-8°C</div>
          <svg
         xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
           style="height: 24px; width: 24px;"
      ...
      <div>
        <div class="text-uppercase text-body-2 ">sun</div>
        <article class="miniWeatherCard">
          <div class="text-body2">-4°C</div>
          <svg
         xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
           style="height: 24px; width: 24px;"
...
const fetchData = async () => {
  try {
    const response = await axios.get('https://api.openweathermap.org/data/2.5/weather', {
      params: {
        q: 'Ontario,ca',
        APPID: '2d48b1d7080d09ea964e645ccd1ec93f',
        units: 'metric',
      },
    });
