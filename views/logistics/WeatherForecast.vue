...
<div class="weather-box">
    <div class="titlebar">
      ...
      <h2 class="city">ONTARIO</h2>
      <h3 class="description">{{ getWeatherDescription().toUpperCase() }}</h3>
      ...
      <div v-if="weatherData">
        <div class="temperature">
            <div class="flex flex-col items-center mb-4">
                <img
                    ...
                    alt="Weather Icon"
                />
                <h2  style="color: rgb(72, 72, 75); font-size:50px;">{{ Math.round(weatherData.main.temp) }}°C</h2>
            </div>
        </div>
        ...
        <div class="col">
            <div class="info">
                <h5>Wind Status</h5>
                <p>{{ weatherData.wind.speed }} mps</p>
            </div>
            <div class="info">
                <h5>Visibility</h5>
        ...
        <div class="col">
            ...
            <div class="info">
                <h5>Air pressure</h5>
                <p>{{ weatherData.main.pressure }} mpa</p>
            </div>
        </div>
    </div>
  </div>
		
  <!-- <div class="weather-box-internal">
...
.weather-box {
    ...
    top: 145px;
    width: 100%;
    right: 0px; /* Adjusted right positioning */
    margin-top: -150px;
    padding: 8px;
    background-image: linear-gradient(#30A2C5, #00242F);
    opacity: 0.9; /* Reduced opacity */
    border-top-left-radius: 70px; /* Increased border-radius for top-left corner */
    border-top-right-radius: 70px; /* Increased border-radius for top-right corner */
    border-bottom-left-radius: 0; /* Set bottom-left corner to square */
    border-bottom-right-radius: 0; /* Set bottom-right corner to square */
    color: white;
    text-align: center;
}
.weather-box-internal {
    width: 100%; /* Make the internal div fill the width of its container */
    right: 0; /* Align with the right edge of the parent div */
    margin-top: 0px;
    padding: 8px;
